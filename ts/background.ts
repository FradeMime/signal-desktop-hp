...
export async function startApp(): Promise<void> {
  ...
  window.storage.onready(async () => {
    ...
    //   avatars: [],
    //   id: '2257745c-a4be-4996-a5df-cd9a880a894a',
    //   e164: '+8613933333333',
    //   uuid: '2257745c-a4be-4996-a5df-cd9a880a894a',
    //   type: 'private',
    //   inbox_position: 0,
    //   isPinned: true,
    //   markedUnread: false,
    ...
    // window.ConversationController.getOrCreate('+8613933333333', 'private');
  ...
  async function onGroupReceived(ev: GroupEvent) {
    log.info(`group v1 groupevent:${ev}`);
  ...
  function onEnvelopeReceived({ envelope }: EnvelopeEvent) {
    log.info(`envelope事件：${JSON.stringify(envelope)}`);
    const ourUuid = window.textsecure.storage.user.getUuid()?.toString();
